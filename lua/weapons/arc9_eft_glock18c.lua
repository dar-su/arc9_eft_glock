...
local rst_single = {
    ...
    { s = path .. "grach_slider_in.wav", t = 12/24 },
    { s =  path .. "generic_jam_shell_ remove_medium3.wav", t = 29/26  },
    { s = "eft_shared/weapon_generic_rifle_spin10.wav", t = 50/26 },
    { s =  path .. "pm_catch_slider.wav", t = 60/26 },
    { s = "eft_shared/weapon_generic_rifle_spin2.wav", t = 70/26 },
}
